...
const Cartpage = () => {
  ...
  //  callulate total price 
  const subtotal= cart.reduce((total,item)=>{
    return total + calculatePrice(item) 
  },0)
  const odertotal=subtotal
  //  decriment 
  ...
  <table className="table ">
   ...
   <td>{index+1}</td>
        ...
        <td>
            <button className='btn bg-slate-300 px-4  text-black hover:bg-white btn-xs border-none'
   ...
   <div className='my-12 py-5 flex flex-col md:flex-row justify-between items-start text-black'>
    ...
    <h3 className='font-medium'> Shopping  Details </h3>
      ...
      <p>TotalPrice: ${odertotal.toFixed(2)}</p>
